...
namespace ToggleSwitch.Borders
{
    ...
    public class ClippingBorder : ContentControl
    {
        ...
        private void UpdateClipSize(Size size)
        {
            ...
            {
                var contentWidth = System.Math.Max(0, size.Width-BorderThickness.Left-BorderThickness.Right);
                var contentHeight = System.Math.Max(0, size.Height-BorderThickness.Top-BorderThickness.Bottom);
